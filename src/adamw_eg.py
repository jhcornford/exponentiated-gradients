# Modified from https://github.com/pytorch/pytorch/blob/97ff6cfd9c86c5c09d7ce775ab64ec5c99230f5d/torch/optim/adamw.py
# Version is 2.3.0 (BSD-3-Clause, see THIRD_PARTY_LICENSES)
    ...
    *,
    ...
    for i, param in enumerate(params):
        ...
        if capturable or differentiable:
            ...
            # EG replaces param.addcdiv_(exp_avg, denom)
            ...
            # EG replaces param.addcdiv_(exp_avg, denom, value=-step_size)
    ...
    *,
    ...
    for ((
        ...
        if capturable:
            ...
            # EG replaces torch._foreach_addcdiv_(device_params, device_exp_avgs, exp_avg_sq_sqrt)
            ...
            torch._foreach_div_(exp_avg_sq_sqrt, bias_correction2_sqrt)
            torch._foreach_add_(exp_avg_sq_sqrt, eps)
            # EG replaces torch._foreach_addcdiv_(device_params, device_exp_avgs, exp_avg_sq_sqrt, step_size)
            torch._foreach_mul_(device_params,
                                torch._foreach_exp(torch._foreach_div(
